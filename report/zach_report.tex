...
Monge-Kantovorich problem. We will return to this later. Furthermore, notice
...
from the Monge-Kantovorich problem. Thus this optimizaiton corresponds
to an \emph{entropy-regularized} version of the Monge-Kantovorich problem.
...
over transport plans in the finite case. In this section we introduce a
Markovian interacting particle system which admits this distribution as
a stationary distribution. The algorithm is described in 

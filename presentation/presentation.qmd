...
This is a **power posterior** — for large $N$ it concentrates near the **minimiser of cross-entropy**
...
$$Q^* = \argmin_{Q \text{ satisfies marginals}} \mathrm{KL}(q \,\|\, r)$$
...
| Many particles | Stirling → KL divergence, power posterior |
